...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Tipo de frontera: ";
  if (frontier_type == Frontier::periodic) {
    std::cout << "periódica" << std::endl;
  } else if (frontier_type == Frontier::fixed_cold) {
    std::cout << "abierta fría" << std::endl;
  } else if (frontier_type == Frontier::fixed_hot) {
    std::cout << "abierta caliente" << std::endl;
  }
  if (input_file != "") {
